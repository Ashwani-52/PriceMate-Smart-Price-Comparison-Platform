...
const AdminProducts = () => {
    ...
    function initialProductState() {
        return {
            ...
            images: [{ public_id: 'sample', url: 'https://via.placeholder.com/300' }],
            marketplacePrices: [
    ...
    const handleAddMarketplace = () => {
        setCurrentProduct({
            ...currentProduct,
            marketplacePrices: [...currentProduct.marketplacePrices, { marketplace: 'Amazon', price: '', productUrl: '', isAvailable: true }]
        });
    };
    ...
    const handleAddSpec = () => {
        const newKey = `Spec${Object.keys(currentProduct.specs || {}).length + 1}`;
        setCurrentProduct({ ...currentProduct, specs: { ...currentProduct.specs, [newKey]: '' } });
    };
                ...
                <div className="bg-white p-6 rounded shadow border max-w-4xl mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium">PriceMate Product ID</label>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div>
                                <label className="block text-sm font-medium">PriceMate Price (₹)</label>
                        ...
                        <div className="border-t pt-4">
                            ...
                            {currentProduct.marketplacePrices.map((mp, index) => (
                                <div key={index} className="grid grid-cols-5 gap-4 mb-2 p-2 bg-gray-50 rounded items-end">
                                    <div>
                                        <label className="text-xs">Marketplace</label>
                                        <select value={mp.marketplace} onChange={(e) => handleMarketplaceChange(index, 'marketplace', e.target.value)} className="w-full border p-1 rounded">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" value={mp.price} onChange={(e) => handleMarketplaceChange(index, 'price', e.target.value)} className="w-full border p-1 rounded" placeholder="0" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <select value={mp.isAvailable} onChange={(e) => handleMarketplaceChange(index, 'isAvailable', e.target.value === 'true')} className="w-full border p-1 rounded">
