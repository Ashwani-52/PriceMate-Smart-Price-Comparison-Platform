...
import { Users, Package, ShoppingBag, DollarSign, ClipboardList } from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    const data = [
        ...
        { name: 'PriceMate', savings: 9000 }, // PriceMate usually saves more
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex space-x-3">
                    <button
                        ...
                        className="bg-green-600 text-white px-4 py-2 rounded flex items-center shadow hover:bg-green-700"
                    >
                        <ClipboardList className="w-5 h-5 mr-2" /> Manage Orders
                    </button>
                    <button
